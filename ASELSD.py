...
mechanism = 'semi-dynamic' # can be set "dynamic" or "semi-dynamic"
############################# Available for User Adjustment ##################################
...
print('################ Using the ' + mechanism + ' mechanism ################\n')
# Load training data
...
w = open('ASELSD_Output_' + mechanism + '.fasta', 'w')
w.writelines(Output)
w.close()
