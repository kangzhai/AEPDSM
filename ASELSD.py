...
# Load training data
TD1MR = np.load('Training data\\TD1MR.npy')
TD2MR = np.load('Training data\\TD2MR.npy')
TD3MR = np.load('Training data\\TD3MR.npy')
TD4MR = np.load('Training data\\TD4MR.npy')
TD5MR = np.load('Training data\\TD5MR.npy')
TD6MR = np.load('Training data\\TD6MR.npy')
TD7MR = np.load('Training data\\TD7MR.npy')
TD8MR = np.load('Training data\\TD8MR.npy')
TD1PCC = np.load('Training data\\TD1PCC.npy')
TD2PCC = np.load('Training data\\TD2PCC.npy')
TD3PCC = np.load('Training data\\TD3PCC.npy')
TD4PCC = np.load('Training data\\TD4PCC.npy')
TD5PCC = np.load('Training data\\TD5PCC.npy')
TD6PCC = np.load('Training data\\TD6PCC.npy')
TD7PCC = np.load('Training data\\TD7PCC.npy')
TD8PCC = np.load('Training data\\TD8PCC.npy')
